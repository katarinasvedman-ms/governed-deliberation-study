...
Read [the process and decision record](docs/governance/process.md) and
[the implementation handoff](docs/governance/COPILOT_HANDOFF.md) before agent-driven work.
They preserve the current task boundaries, approvals, and stop/go gates.
